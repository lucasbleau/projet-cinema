 ...
 */
final class Version20240407134343 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE film (id INT AUTO_INCREMENT NOT NULL, titre_film VARCHAR(150) NOT NULL, duree_film INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, seance_id INT DEFAULT NULL, users_id INT DEFAULT NULL, nombre_place_resa INT NOT NULL, date_resa DATETIME NOT NULL, montant_total DOUBLE PRECISION NOT NULL, INDEX IDX_42C84955E3797A94 (seance_id), INDEX IDX_42C8495567B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE salle (id INT AUTO_INCREMENT NOT NULL, nom_salle VARCHAR(100) NOT NULL, nombres_places INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
